import { Brands } from '../Brands/Brands.ts'
...
export const Main = () => {
  ...
  useEffect(() => {
    const nextTitles = ['Next word 2', 'Next word 3', 'Special word']
    let index = 0
  ...
  const info = {
    title: title,
    subtitle:
      'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Iure quia nulla itaque in autem cum voluptates soluta velit adipisci id.',
  }
  ...
  return (
    <main>
      <TitleSection title={info.title} subtitle={info.subtitle} />
      <Brands logos={logos} />
    </main>
  )
}
